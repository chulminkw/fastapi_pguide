...
INSERT INTO blog_db.`user` (name,email,hashed_password) VALUES	 
	 ('둘리','dooley@gmail.com','$2b$12$KZQQRitEnVGb/sVwsn7p5u3NAv/OFd5jFCtyV3sZbilXfvaDKykx.');
INSERT INTO blog_db.`user` (name,email,hashed_password) VALUES
	 ('고길동','gildong@gmail.com','$2b$12$JPzgsAlsqIqkmiyisYeKu.GAiQ.QpD99XoBW3HBZYH.UQGkWjB7KW');
INSERT INTO blog_db.`user` (name,email,hashed_password) VALUES
	 ('도우넛','doughnut@gmail.com','$2b$12$5CdnB.G58NRIyG6qUNgMSeQsFcvmIE2tQO0eiXAqXS9gW50SgkgjC');
...
create index author_id_idx on blog(author_id);

insert into blog(title, author_id, content, modified_dt)
values ('FastAPI는 어떤 장점이 있는가?', 1, 
...
insert into blog(title, author_id, content, modified_dt)
values ('FastAPI를 어떻게 사용하면 좋을까요?', 3, 
